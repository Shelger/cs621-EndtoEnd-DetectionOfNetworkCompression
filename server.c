...
int
bindSocket(int sockfd, struct sockaddr* my_addr, int addrlen) 
{
...
int
acceptSocket(int sockfd, struct sockaddr* my_addr, int addrlen)
{
...
double
recordTime(int sockfd, struct sockaddr_in *client_addr, socklen_t client_struct_length, ConfigInfo *cfg)
{
